...
from data_locations import LOC_FORECASTS_fgco2_normal, LOC_FORECASTS_fgco2_normal_pi, LOC_FORECASTS_fgco2_normal_2pi, LOC_OBSERVATIONS_fgco2_v2023, LOC_FORECASTS_fgco2
import gc
...
if __name__ == "__main__":
    ...
    params["arch"] = None
    params['version'] = 3 ### 0, 1 , 2 ,3
    params['beta'] =  dict(start = 0, end =0.2, start_epoch = 1 , end_epoch = 50)  
    params['reg_scale'] = 0
    
    out_dir_x  = f'/space/hall5/sitestore/eccc/crd/ccrn/users/rpg002/output/fgco2_ems/SOM-FFN/results/{params["model"].__name__}/run_set_final_toy'
    ...
    if fake_data is not None:
        if fake_data == '2pi':
            ...
            out_dir = out_dir + f'_fake_data_normal_pi_beta0.2_weightedMSE'
        else :
            data_dir_forecast = LOC_FORECASTS_fgco2_normal
            out_dir = out_dir + f'_fake_data_normal_beta0.2_weightedMSE'
        unit_change = 1
    ...
    run_training(params, n_years=n_years, lead_years=lead_years,lead_time = lead_time, n_runs=n_runs, results_dir=out_dir, numpy_seed=None, torch_seed=None, save = True)
