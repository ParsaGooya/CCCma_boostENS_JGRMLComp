...
def run_training(params,var, n_years, lead_years, lead_time = None, n_runs=1, results_dir=None, numpy_seed=None, torch_seed=None, save = False):
...
if __name__ == "__main__":
    ...
    params = {
        ...
        'condition_embedding_size' : [3000, 3000, 3000, 3000,3000, 5], #[3000, 3000, 1500, 1500, 100] , #[1500, 1500,1500,1500,1500,1500,10],
    ...
    params['beta'] =   dict(start = 0, end =0.25, start_epoch = 1 , end_epoch = params['epochs'])  
    params['reg_scale'] = 0
    
    out_dir_x  = f'/space/hall5/sitestore/eccc/crd/ccrn/users/rpg002/output/{var}/SOM-FFN/results/{params["model"].__name__}/run_set_final_picontrol'
    ...
    out_dir = out_dir + f"_TSE{len(params['ensemble_list'])}_LS{params['hidden_dims'][0][-1]}_beta0.25_test" 
    ...
    run_training(params,var, n_years=n_years, lead_years=lead_years,lead_time = lead_time, n_runs=n_runs, results_dir=out_dir, numpy_seed=1, torch_seed=1, save = True)
